...
func initialize_board() -> void :
	...
	GameManager.activate_perk(GameData.Perks.PROJECTILE_HIT);
	GameManager.activate_perk(GameData.Perks.PROJECTILE_MULT);
	GameManager.activate_perk(GameData.Perks.DREAM);
