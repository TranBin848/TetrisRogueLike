...
# =============================================================================
# TETROMINO SHAPES (from PieceRenderer)
# =============================================================================
...
func get_shape_blocks(shape_type: ShapeType, rotation: int = 0) -> Array[Vector2i]:
	...
	rotation = rotation % 4
	var shape = PIECE_SHAPES[shape_type][rotation]
...
func get_piece_bounds(shape_type: ShapeType, rotation: int = 0) -> Rect2i:
	if not PIECE_SHAPES.has(shape_type):
		return Rect2i()
