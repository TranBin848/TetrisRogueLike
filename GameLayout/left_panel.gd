...
@onready var score_label: LabelShadowed = %CurrentScoreLabel
@onready var target_score_label: LabelShadowed = %TargetScoreLabel
@onready var points_label: RichTextLabelShadowed = %BluePointsValueLabel
@onready var multiplier_label: RichTextLabelShadowed = %RedPointsValueLabel
